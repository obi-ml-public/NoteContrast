...
from transformers.models.roberta.modeling_roberta import RobertaEmbeddings, RobertaForSequenceClassification
...
class ICDRobertaForSequenceClassification(RobertaForSequenceClassification):
    """
    Subclass of RobertaForMaskedLM that creates the input embeddings differently.
    Specifically uses ICDRobertaEmbeddings where sinusoidal position embeddings can be used.
    """
