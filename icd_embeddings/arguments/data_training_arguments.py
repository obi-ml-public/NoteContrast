...
class DataTrainingArguments:
    ...
    text_column_name: Optional[str] = field(
        default='text',
        metadata={"help": "The column that contains the ICD data"}
    )
    position_ids_column_name: Optional[str] = field(
        default=None,
        metadata={"help": "The column that contains the position ids"}
    )
    token_type_ids_column_name: Optional[str] = field(
        default=None,
        metadata={"help": "The column that contains the token type ids"}
    )
