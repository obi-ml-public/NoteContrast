...
class PreTrainDataset(object):
    ...
    def get_eval_dataset(self, max_eval_samples: Optional[int], shuffle: bool = True, seed: int = 41) -> Optional[Dataset]:
        """
        ...
        Args:
            ...
            shuffle (bool, defaults to `True`): Whether to shuffle the evaluation dataset
