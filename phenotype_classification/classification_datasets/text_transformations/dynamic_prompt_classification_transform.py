...
class DynamicPromptClassificationTransformation(object):
    ...
    def encode_train(self, batch):
        ...
        prompt_labels = self._label_transform.pre_tokenize(batch['prompt_' + self._label_column_name])
        ...
        tokenized_data['labels'] = self._label_transform.tokenize_function(
            ...
            prompt_labels_list=prompt_labels
        )
